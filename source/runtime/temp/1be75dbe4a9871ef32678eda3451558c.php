                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="panel-shop__content hide">
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                        <div class="am-input-group am-margin-bottom">
                                            ...
                                            <input type="text" name="goods[first_shop_money]" value=""
                                                   class="am-form-field">
                                            <span class="widget-shop__unit am-input-group-label am-input-group-label__right">%</span>
                                        </div>
                                        <div class="am-input-group am-margin-bottom">
                                            <span class="am-input-group-label am-input-group-label__left">上级佣金：</span>
                                            <input type="text" name="goods[second_shop_money]" value=""
                                                   class="am-form-field">
                                            <span class="widget-shop__unit am-input-group-label am-input-group-label__right">%</span>
                                        </div>
                                        ...
                                        <div class="help-block">
                                            <p>
                                                <small>注：如不开启单独分销则默认使用全局门店分润比例</small>
                                            </p>
                                        </div>
                                    </div>
                                </div>
