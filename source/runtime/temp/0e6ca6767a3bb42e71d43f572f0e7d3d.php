<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/shop/edit.php";i:1561082318;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;s:99:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/_template/file_library.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="shop[parent_shop_id]"
                                           value="<?= $model['parent_shop_id'] ?>" required>
                                    <small>没有则填0</small>
                                </div>
                            </div>
                            <div class="am-form-group">
