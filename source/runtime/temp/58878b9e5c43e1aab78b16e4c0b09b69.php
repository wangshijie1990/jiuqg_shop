<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/apps/sharing/comment/index.php";i:1560414019;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if (checkPrivilege('apps.sharing.comment/delete')): ?>
                                                <a href="javascript:void(0);"
                                                   class="item-delete tpl-table-black-operation-del"
                                                   data-id="<?= $item['comment_id'] ?>">
                                                    <i class="am-icon-trash"></i> 删除
                                                </a>
                                            <?php endif; if (checkPrivilege('apps.sharing.order/detail')): ?>
