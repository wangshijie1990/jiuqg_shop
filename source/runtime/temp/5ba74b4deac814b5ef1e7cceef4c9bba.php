<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/apps/sharing/goods/index.php";i:1560414020;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <form class="toolbar-form" action="">
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
                                    ...
                                    <?php endif; if (checkPrivilege('apps.sharing.goods/copy_master')): ?>
                                        <div class="am-btn-group am-btn-group-xs">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if (checkPrivilege('apps.sharing.goods/delete')): ?>
                                                <a href="javascript:;" class="item-delete tpl-table-black-operation-del"
                                                   data-id="<?= $item['goods_id'] ?>">
                                                    <i class="am-icon-trash"></i> 删除
                                                </a>
                                            <?php endif; if (checkPrivilege('apps.sharing.goods/copy')): ?>
