<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/user/index.php";i:1560414052;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if (checkPrivilege('user/recharge')): ?>
                                            ...
                                            <div class="j-opSelect operation-select am-dropdown">
                                                ...
                                                <ul class="am-dropdown-content" data-id="<?= $item['user_id'] ?>">
                                                    ...
                                                    <?php endif; if (checkPrivilege('user.recharge/order')): ?>
                                                        <li>
                                                            <a class="am-dropdown-item" target="_blank"
