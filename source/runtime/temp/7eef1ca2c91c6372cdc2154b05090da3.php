<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/shop/clerk/edit.php";i:1561432342;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 提现 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="clerk[draw]" value="10" data-am-ucheck
                                            <?= $model['draw'] == 10 ? 'checked' : '' ?>>
                                        允许
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="clerk[draw]" value="20" data-am-ucheck
                                            <?= $model['draw'] == 20 ? 'checked' : '' ?>>
                                        禁止
                                    </label>
                                </div>
                            </div>
