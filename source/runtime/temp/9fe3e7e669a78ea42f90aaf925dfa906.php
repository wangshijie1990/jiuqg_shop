<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/apps/dealer/withdraw/index.php";i:1560414017;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (in_array($item['apply_status'], [10, 20])) : if (checkPrivilege('apps.dealer.withdraw/submit')): ?>
                                                    <a class="j-audit" data-id="<?= $item['id'] ?>"
                                                       href="javascript:void(0);">
                                                        <i class="am-icon-pencil"></i> 审核
                                                    </a>
                                                <?php endif; if ($item['apply_status'] == 20) : if (checkPrivilege('apps.dealer.withdraw/money')): ?>
                                                        <a class="j-money tpl-table-black-operation-del"
                                                           data-id="<?= $item['id'] ?>" href="javascript:void(0);">确认打款
                                                        </a>
                                                    <?php endif; endif; if ($item['apply_status'] == 20 && $item['pay_type']['value'] == 10) : if (checkPrivilege('apps.dealer.withdraw/wechat_pay')): ?>
