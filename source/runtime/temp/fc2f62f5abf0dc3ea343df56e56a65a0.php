<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/shop/order/index.php";i:1561101806;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><?=$item['is_settled']==0?'<span class="am-badge">未结算</span>':'<span class="am-badge am-badge-success">已结算</span>'?></td>
