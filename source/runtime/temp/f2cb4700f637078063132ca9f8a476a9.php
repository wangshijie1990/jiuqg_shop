<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/setting/trade.php";i:1562311927;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require">已配送订单 </label>
                                <div class="am-u-sm-9">
                                    <div class="am-u-sm-6">
                                        <input type="number" class="am-form-field" name="trade[order][transfer_days]"
                                               value="<?= $values['order']['transfer_days'] ?>" required>
                                    </div>
                                    <label class="am-u-sm-6 am-form-label am-text-left">天后自动完成订单</label>
                                    <div class="help-block am-u-sm-12">
                                        <small>如果在期间内未提货，系统自动完成订单，设置0天不自动完成订单</small>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
