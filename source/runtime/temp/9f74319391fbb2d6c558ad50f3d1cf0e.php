<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/order/index.php";i:1562893094;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            ...
                                            <?php endif; if (checkPrivilege('order.operate/batchdelivery')): if (in_array($dataType, ['all', 'delivery'])): ?>
                                                ...
                                                <?php endif; endif; if (checkPrivilege('order.operate/batchtransfer')): if (in_array($dataType, ['all', 'transfer'])): ?>
                                                    <a class="j-export am-btn am-btn-secondary am-radius"
                                                       href="<?= url('order.operate/batchtransfer') ?>">
                                ...
                                <div class="am fr">
                                    ...
                                    <div class="am-form-group tpl-form-border-form am-fl">
                                        <input type="text" name="start_time"
                                               class="am-form-field"
                                               value="<?= $request->get('start_time') ?>" autocomplete="off" placeholder="请选择起始日期"
                                               data-am-datepicker>
                                    </div>
                                    <div class="am-form-group tpl-form-border-form am-fl">
                                        <input type="text" name="end_time"
                                               class="am-form-field"
                                               value="<?= $request->get('end_time') ?>" autocomplete="off" placeholder="请选择截止日期"
                                               data-am-datepicker>
                                    </div>
                                    <div class="am-form-group am-fl">
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($i === 1) : $goodsCount = count($order['goods']); ?>
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                ...
                                                <?php if($order['extract_shop_id']>0):?>
                                                <p>配送状态：
                                                    <span class="am-badge
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                <div class="tpl-table-black-operation">
                                                    ...
                                                    <?php endif; if (checkPrivilege(['order/detail', 'order/delivery'])): if ($order['pay_status']['value'] == 20
                                                        ...
                                                        <?php endif; endif; if (checkPrivilege(['order/detail', 'order/transfer'])): if ($order['pay_status']['value'] == 20
                                                            && $order['delivery_status']['value'] == 10
                                                            && $order['extract_shop_id']>0
                                                            ...
                                                            <a class="tpl-table-black-operation"
                                                               href="<?= url('order/detail#transfer',
