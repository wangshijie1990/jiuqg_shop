<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:107:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/apps/sharing/order/refund/index.php";i:1560414021;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('apps.sharing.order.refund/detail')): ?>
                                                <a class="tpl-table-black-operation-green"
                                                   href="<?= $url ?>">售后详情</a>
                                            <?php endif; if (checkPrivilege(['apps.sharing.order.refund/detail', 'apps.sharing.order.refund/audit'])): if ($item['is_agree']['value'] == 0): ?>
                                                    <a class="tpl-table-black-operation-del"
                                                       href="<?= $url ?>#audit">去审核</a>
                                                <?php endif; endif; if (checkPrivilege(['apps.sharing.order.refund/detail', 'apps.sharing.order.refund/receipt'])): if (
                                                    $item['type']['value'] == 10
                                                    && $item['is_agree']['value'] == 10
                                                    && $item['is_user_send'] == 1
                                                    && $item['is_receipt'] == 0
