<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/order/detail.php";i:1561089227;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="widget am-cf">
                <div class="widget__order-detail widget-body am-margin-bottom-lg">
                    ...
                    <?php if (
                        ...
                        && !in_array($detail['order_status']['value'], [20, 21])   // 订单状态：未取消
                        && $detail['transfer_status']==10
                    ): ?>
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">配送信息</div>
                        </div>
                        <?php if ($detail['transfer_status'] == 10): if (checkPrivilege('order/transfer')): ?>
                                <!-- 去配送 -->
                                <form id="transfer" class="my-form am-form tpl-form-line-form" method="post"
                                      action="<?= url('order/transfer', ['order_id' => $detail['order_id']]) ?>">
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">配送员 </label>
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="text" class="tpl-form-input" name="order[transfer_people]" required>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">配送单号 </label>
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="text" class="tpl-form-input" name="order[transfer_no]" required>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3 am-margin-top-lg">
                            ...
                            <div class="am-scrollable-horizontal">
                                <table class="regional-table am-table am-table-bordered am-table-centered
                                    ...
                                    <tr>
                                        <td><?= $detail['transfer_people'] ?></td>
                                        <td><?= $detail['transfer_no'] ?></td>
                                        <td>
                                             <span class="am-badge am-badge-success">已配送</span>
                                        </td>
                                        <td>
                                            <?= date('Y-m-d H:i:s', $detail['transfer_time']) ?>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
