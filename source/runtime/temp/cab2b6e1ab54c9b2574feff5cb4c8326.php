<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/jqg.wanheezg.com/shop/web/../source/application/store/view/shop/clerk/add.php";i:1561453950;s:83:"/www/wwwroot/jqg.wanheezg.com/shop/source/application/store/view/layouts/layout.php";i:1560414032;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <label class="am-radio-inline">
                                        <input type="radio" name="clerk[draw]" value="20" data-am-ucheck checked>
                                        禁止
                                    </label>
                                </div>
                            </div>
