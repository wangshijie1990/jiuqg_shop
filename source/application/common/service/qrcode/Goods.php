...
class Goods extends Base
{
     ...
     * @param int $goodsType
     */
    public function __construct($goods, $user,$shop_id=0, $goodsType = 10)
    {
        parent::__construct();
        // 商品信息
        $this->goods = $goods;
        ...
        $this->shop_id = $shop_id?$shop_id:0;
        // 商品类型：10商城商品 20拼团商品
    ...
    public function getImage()
    {
        ...
        // 小程序码参数
        $scene = "gid:{$this->goods['goods_id']},shopid:{$this->shop_id},uid:" . ($this->user_id ?: '');
        // 下载小程序码
    ...
    {
        return 'goods_' . md5("{$this->user_id}_{$this->shop_id}_{$this->goodsType}_{$this->goods['goods_id']}") . '.png';
    }
