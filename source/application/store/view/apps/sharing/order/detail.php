            ...
            <div class="widget am-cf">
                <div class="widget__order-detail widget-body am-margin-bottom-lg">
                    ...
                    <?php if (
                        ...
                        <?php if ($detail['transfer_status'] == 10): ?>
                            <?php if (checkPrivilege('apps.sharing.order/transfer')): ?>
                                <!-- 去配送 -->
                                <form id="transfer" class="my-form am-form tpl-form-line-form" method="post"
                                      action="<?= url('apps.sharing.order/transfer', ['order_id' => $detail['order_id']]) ?>">
                                    <div class="am-form-group">
